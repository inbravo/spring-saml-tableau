package com.inbravo.spring.boot.security.saml.web;
...
public class CommonTestSupport {
  ...
  public static final List<GrantedAuthority> AUTHORITIES = Collections.singletonList(new SimpleGrantedAuthority(USER_ROLE));
  ...
  public MockHttpSession mockHttpSession(boolean secured) {
    ...
    if (secured) {
      ExpiringUsernameAuthenticationToken principal = new ExpiringUsernameAuthenticationToken(null, USER_DETAILS, USER_NAME, AUTHORITIES);
  ...
  public MockHttpSession mockAnonymousHttpSession() {
    ...
    AnonymousAuthenticationToken principal = new AnonymousAuthenticationToken(ANONYMOUS_USER_KEY, ANONYMOUS_USER_PRINCIPAL, AUTHORITIES);
